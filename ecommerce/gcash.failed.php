...
if( confirm_sesskey() ){
    ...
    if( $cartitems['cartid'] && $userdetails && is_array($userdetails) ) {
        $eventother = [
...
echo elearnifiedhelper::notice('Error Processing Payment!', 'fa fa-times', 'We have encountered an error processing your payment. <br>Please reach out to <a target="_blank" href="mailto:contact@elearnified.com">contact@elearnified.com</a> <br>if you need further help.', ['class'=>'danger'],0,new moodle_url('/local/ecommerce/historydetails/index.php',['id'=>$encryptedid]));
exit;