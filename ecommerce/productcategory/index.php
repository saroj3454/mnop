...
$pagetitle = $header = 'Productcategory';
$pagettype = 'productcategory-manage';
$url = '/local/ecommerce/productcategory/index.php';
...
$url = $url ?: '/local/ecommerce/productcategory/index.php';
