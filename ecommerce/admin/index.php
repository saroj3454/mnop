...
$pagettype = 'product-manage';
$url = '/local/ecommerce/admin/index.php';
...
$url = $url ?: '/local/ecommerce/admin/index.php';
...
$PAGE->requires->css(new \moodle_url($CFG->wwwroot. "/local/ecommerce/js/chosen.min.css"));
$PAGE->requires->js(new \moodle_url($CFG->wwwroot. "/local/ecommerce/js/chosen.jquery.min.js"));
/**
