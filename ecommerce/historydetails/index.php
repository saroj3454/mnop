...
$pagetitle = $header = 'Payment History Details';   ////
$pagettype = 'payment-history-details';   /////
$url = '/local/ecommerce/historydetails/index.php';   /////
...
$url = $url ?: '/local/ecommerce/historydetails/index.php';   /////
...
$PAGE->set_pagelayout('product-catalog');
